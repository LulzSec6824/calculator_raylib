...
// TODO: Those defines should probably be removed from here, I prefer to let the
// user manage them
...
#endif
#ifndef SUPPORT_FILEFORMAT_PNG  // Wayland uses png for prints, at least it was
                                // on 22 LTS ubuntu
...
#define RL_SUPPORT_MESH_GPU_SKINNING \
    1  // GPU skinning, comment if your GPU does not support more than 8 VBOs
...
#define RL_DEFAULT_BATCH_MAX_TEXTURE_UNITS \
    4  // Maximum number of textures units that can be activated on batch
...
#define RL_CULL_DISTANCE_NEAR \
    0.05  // Default projection matrix near cull distance
#define RL_CULL_DISTANCE_FAR \
    4000.0  // Default projection matrix far cull distance
...
#define RL_DEFAULT_SHADER_UNIFORM_NAME_COLOR \
    "colDiffuse"  // color diffuse (base tint color, multiplied by texture
                  // color)
